...
(fact "Can search"
  (let [john {:email "jbar@foo.com" :name "John Doe"}
    ...
    (let [john (find-by-email (:email john))
      ...
      (assign-role john "context1" "editor")
      (assign-role earl "context1" "reader")
      (assign-entity john "context1" "editor" "vicia:faba")
      (assign-entity earl "context1" "reader" "vicia:alba")
